Rails.application.configure do
  ...
  # config.cache_store = :dalli_store, "http://127.0.0.1:11211", { :namespace => 'artsapi', :expires_in => 1.year, :compress => true }
  ...
  config.action_mailer.default_url_options = { :host => 'data.artsapi.com' }
  ...
  config.action_mailer.smtp_settings = {
    ...
    :password             => ENV['ADMIN_MAILER_PASSWORD'], # pass this in from env to avoid accidents!
    :domain               => "data.artsapi.com",
